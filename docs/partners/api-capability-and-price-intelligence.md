...
1. **Partnerize / P1:** ask P1 or Partnerize to regenerate/repair the configured feeds and confirm comparison-site use is permitted before ingestion. Do not build against the dead URLs.
